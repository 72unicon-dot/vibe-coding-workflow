...
const STAGES = [
  {
    ...
    promptTemplate: `당신은 바이브코딩 기반 AI 앱 서비스 기획 전문가입니다.

나는 앱 개발 초보자이며, AI 도구를 활용해 실제 작동하는 앱 서비스를 만들고 싶습니다.  
아직 구체적인 아이디어는 없으며, 내가 가진 경험과 관심사를 바탕으로 좋은 앱 아이디어를 찾고 싶습니다.

## 나의 정보
- 나의 직무/경험: [여기에 작성]
- 내가 잘 아는 분야: [여기에 작성]
- 평소 불편하다고 느낀 문제: [여기에 작성]
- 관심 있는 사용자: [예: 학생, 직장인, 강사, 소상공인, 농장주, 제조 관리자]
- 만들고 싶은 앱 형태: [웹앱 / 모바일앱 / 관리자 대시보드 / AI 챗봇 / 업무 자동화 앱]
- 개발 가능 기간: [예: 4주, 8주, 12주]
- 개발 수준: [초급 / 중급]
- 사용 예정 도구: [예: ChatGPT, Claude, Antigravity, Firebase, GitHub, Vercel]

## 아이디어 도출 요청
위 정보를 바탕으로 실제 개발 가능한 앱 아이디어를 1개 제안해 주세요.
...
## 출력 형식
제안하는 1개의 아이디어에 대해 다음 단계로 바로 넘어갈 수 있도록 아래 문서를 작성해 주세요.
...
주의사항: 껍데기 폴더만 만들지 말고, 브라우저에서 바로 실행(npm run dev)할 수 있도록 반드시 Vite 기반(npm create vite@latest)으로 프로젝트를 초기화해줘. Tailwind CSS 설치와 설정(tailwind.config.js, index.css) 명령어도 모두 포함해야 해.
